...
export function followUserByUsername(http: HttpClient, rootUrl: string, params: FollowUserByUsername$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'profile': Profile;
}>> {
